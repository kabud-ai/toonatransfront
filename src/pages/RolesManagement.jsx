...
const MODULES = [
  ...
  { key: 'job_cards', label: '📝 Fiches de Travail', permissions: ['view', 'create', 'edit', 'delete'] },
  { key: 'workstations', label: '⚙️ Postes de Travail', permissions: ['view', 'create', 'edit', 'delete'] },
  { key: 'routings', label: '🔀 Gammes', permissions: ['view', 'create', 'edit', 'delete'] },
  { key: 'subcontracting', label: '🚚 Sous-Traitance', permissions: ['view', 'create', 'edit', 'delete', 'approve'] },
  { key: 'scrap', label: '🗑️ Rebuts', permissions: ['view', 'create', 'edit', 'delete'] },
  ...
  { key: 'lots', label: '🏷️ Lots', permissions: ['view', 'create', 'edit', 'delete', 'quarantine'] },
  ...
  { key: 'equipment', label: '⚙️ Équipements', permissions: ['view', 'create', 'edit', 'delete'] },
  { key: 'settings', label: '⚙️ Paramètres', permissions: ['view', 'edit'] },
  { key: 'users', label: '👥 Utilisateurs', permissions: ['view', 'create', 'edit', 'delete'] },
  { key: 'roles', label: '🛡️ Rôles', permissions: ['view', 'create', 'edit', 'delete'] },
